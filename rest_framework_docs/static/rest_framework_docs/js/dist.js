...
var Endpoints = React.createClass({
  ...
  onSubmit: function onSubmit(e) {
    ...
    apiRequests.get('https://api.github.com/repos/' + owner + '/' + repo).end(function (err, response) {
  ...
  render: function render() {
    return React.createElement(
      ...
      React.createElement(
        Loading,
        { className: 'loading', shouldShow: this.state.loading },
        React.createElement(
          'h3',
          null,
          'Grabbing your repository details from ',
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', { type: 'text', id: 'name', className: 'form-control input-lg', value: this.state.url, placeholder: 'Example: http://www.github.com/atom/electron', onChange: this.handleChange.bind(this, 'url') })
        ),
        ...
        React.createElement(
          'button',
          { className: 'btn btn-primary btn-lg btn-block', disabled: this.state.submitDisabled, onClick: this.onSubmit },
...
},{"react":158,"underscore":159}],161:[function(require,module,exports){
'use strict';
...
ReactDOM.render(React.createElement(Endpoints, { items: endpoints, tags: tags }), document.getElementById('endpoints'));

},{"./components/endpoints":160,"react":158,"react-dom":2}]},{},[161]);
